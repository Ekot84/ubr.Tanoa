...
scclootSpawnWaitTime = 150;		// How often loot is spawned in seconds
scclootCleanupWaitTime = 150;	// How often loot is cleaned up in seconds
scclootSpawnRange = 1000;		// How close the player must be to a building to spawn loot
scclootCleanupRange = 2500;		// How far the player must be from a building before loot is cleaned up
